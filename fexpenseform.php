        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Final Expense</h1>
...
<div class="container mt-5">
      <div class="card">
        ...
        <form action="fexpense.php" method="post">
